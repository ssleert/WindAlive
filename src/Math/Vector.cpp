...
struct Vector2
{
  ...
  fn operator-() const->Vector2 { return { -x, -y }; }
  ...
  fn dot(Vector2 other) const -> float { return x * other.x + y * other.y; }

  fn lengthSquared() const -> float { return x * x + y * y; }
...
struct Vector3
{
  ...
  fn operator-() const->Vector3 { return { -x, -y, -z }; }
  ...
  fn lengthSquared() const -> float { return x * x + y * y + z * z; }
